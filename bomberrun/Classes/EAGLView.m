...
//diviser le render a 2;
static bool renderTime;
//diviser le render a3;
static bool renderTime3;
...
- (void)touchesBegan:(NSSet*)touches withEvent:(UIEvent*)event {
    AbstractScene * scne = [sharedGameController currentScene];
    [scne touchesBegan:touches withEvent:event view:self ];
}
